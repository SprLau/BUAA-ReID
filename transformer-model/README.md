...
This implementation is based on **Attention is All You Need** - ***Google Brain, 2017***
<br><br>
...
In `main.py`, these variables can be manually changed:
...
If you do, remember to accordingly modify parameters in `config.py`.

To run, simply run this in your terminal:
